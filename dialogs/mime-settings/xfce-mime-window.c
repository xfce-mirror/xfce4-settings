...
xfce_mime_window_init (XfceMimeWindow *window)
{
  ...
  g_assert (XFCE_MIME_HELPER_N_CATEGORIES == 8);
  ...
  label = g_object_new (GTK_TYPE_LABEL, "attributes", window->attrs_bold, "label", _("Text Editor"), NULL);
  gtk_frame_set_label_widget (GTK_FRAME (frame), label);
  gtk_widget_show (label);
  ...
  label = gtk_label_new (_("The default Text Editor will be used to open and edit text files."));
  g_object_set (label, "xalign", 0.0f, "yalign", 0.0f, "wrap", TRUE, NULL);
  gtk_box_pack_start (GTK_BOX (box), label, FALSE, FALSE, 0);
  gtk_widget_show (label);

  chooser = xfce_mime_helper_chooser_new (XFCE_MIME_HELPER_TEXTEDITOR);
  gtk_box_pack_start (GTK_BOX (box), chooser, FALSE, FALSE, 0);
  gtk_widget_show (chooser);
  ...
  /*
     Media
   */
  label = gtk_label_new_with_mnemonic (_("_Media"));
  vbox = g_object_new (GTK_TYPE_BOX, "orientation", GTK_ORIENTATION_VERTICAL, "border-width", 12, "spacing", 18, NULL);
  gtk_notebook_append_page (GTK_NOTEBOOK (notebook), vbox, label);
  gtk_widget_show (label);
  gtk_widget_show (vbox);
  ...
  label = g_object_new (GTK_TYPE_LABEL, "attributes", window->attrs_bold, "label", _("Image Viewer"), NULL);
  gtk_frame_set_label_widget (GTK_FRAME (frame), label);
  gtk_widget_show (label);
  ...
  label = gtk_label_new (_("The default Image Viewer will be used to display image files."));
  g_object_set (label, "xalign", 0.0f, "yalign", 0.0f, "wrap", TRUE, NULL);
  gtk_box_pack_start (GTK_BOX (box), label, FALSE, FALSE, 0);
  gtk_widget_show (label);

  chooser = xfce_mime_helper_chooser_new (XFCE_MIME_HELPER_IMAGEVIEWER);
  gtk_box_pack_start (GTK_BOX (box), chooser, FALSE, FALSE, 0);
  gtk_widget_show (chooser);
  ...
  label = g_object_new (GTK_TYPE_LABEL, "attributes", window->attrs_bold, "label", _("Video Player"), NULL);
  gtk_frame_set_label_widget (GTK_FRAME (frame), label);
  gtk_widget_show (label);
  ...
  label = gtk_label_new (_("The default Video Player will be used to play video files."));
  g_object_set (label, "xalign", 0.0f, "yalign", 0.0f, "wrap", TRUE, NULL);
  gtk_box_pack_start (GTK_BOX (box), label, FALSE, FALSE, 0);
  gtk_widget_show (label);

  chooser = xfce_mime_helper_chooser_new (XFCE_MIME_HELPER_VIDEOPLAYER);
  gtk_box_pack_start (GTK_BOX (box), chooser, FALSE, FALSE, 0);
  gtk_widget_show (chooser);
