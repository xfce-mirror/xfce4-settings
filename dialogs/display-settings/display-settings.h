...
XfceDisplaySettings     *xfce_display_settings_new                     (gboolean                 opt_minimal,
                                                                        GError                 **error);
gboolean                 xfce_display_settings_is_minimal              (XfceDisplaySettings     *settings);
GtkBuilder              *xfce_display_settings_get_builder             (XfceDisplaySettings     *settings);
XfconfChannel           *xfce_display_settings_get_channel             (XfceDisplaySettings     *settings);
GtkWidget               *xfce_display_settings_get_scroll_area         (XfceDisplaySettings     *settings);
GHashTable              *xfce_display_settings_get_popups              (XfceDisplaySettings     *settings);
GList                   *xfce_display_settings_get_outputs             (XfceDisplaySettings     *settings);
void                     xfce_display_settings_set_outputs             (XfceDisplaySettings     *settings);
void                     xfce_display_settings_populate_profile_list   (XfceDisplaySettings     *settings);
void                     xfce_display_settings_populate_combobox       (XfceDisplaySettings     *settings);
...
guint                    xfce_display_settings_get_n_outputs           (XfceDisplaySettings     *settings);
...
void                     xfce_display_settings_get_geometry            (XfceDisplaySettings     *settings,
                                                                        guint                    output_id,
                                                                        GdkRectangle            *geometry);
RotationFlags            xfce_display_settings_get_rotation            (XfceDisplaySettings     *settings,
                                                                        guint                    output_id);
void                     xfce_display_settings_set_rotation            (XfceDisplaySettings     *settings,
                                                                        guint                    output_id,
                                                                        RotationFlags            rotation);
...
void                     xfce_display_settings_set_mode                (XfceDisplaySettings     *settings,
                                                                        guint                    output_id,
                                                                        guint                    mode_id);
void                     xfce_display_settings_set_position            (XfceDisplaySettings     *settings,
                                                                        guint                    output_id,
                                                                        gint                     x,
                                                                        gint                     y);
gboolean                 xfce_display_settings_is_active               (XfceDisplaySettings     *settings,
                                                                        guint                    output_id);
void                     xfce_display_settings_set_active              (XfceDisplaySettings     *settings,
                                                                        guint                    output_id,
                                                                        gboolean                 active);
gboolean                 xfce_display_settings_is_primary              (XfceDisplaySettings     *settings,
                                                                        guint                    output_id);
void                     xfce_display_settings_set_primary             (XfceDisplaySettings     *settings,
                                                                        guint                    output_id,
                                                                        gboolean                 primary);
