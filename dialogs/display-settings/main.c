...
{
    GtkBuilder *builder = xfce_display_settings_get_builder (settings);
    GtkToggleButton *extend_displays = GTK_TOGGLE_BUTTON (gtk_builder_get_object (builder, "extend"));
    GtkTreeIter iter;
    gchar *text;
    ...
    {
        display_settings_minimal_load_icon (builder, "image-display1", "xfce-display1-left");
        display_settings_minimal_load_icon (builder, "image-extend", "xfce-display-extend-right");
        display_settings_minimal_load_icon (builder, "image-display2", "xfce-display2-right");
    }
    else
    {
        display_settings_minimal_load_icon (builder, "image-display1", "xfce-display1-right");
        display_settings_minimal_load_icon (builder, "image-extend", "xfce-display-extend-left");
        display_settings_minimal_load_icon (builder, "image-display2", "xfce-display2-left");
    }

    if (gtk_toggle_button_get_active (extend_displays))
    {
        gtk_toggle_button_toggled (extend_displays);
    }
}
